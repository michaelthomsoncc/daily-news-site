# Generate Thady Boyle ancestry MP3s via xAI TTS API
...
$files = @(
    @{ src = "1.txt"; out = "01-mayo-to-durham.mp3" }
    @{ src = "2.txt"; out = "02-easington-roots.mp3" }
    @{ src = "3.txt"; out = "03-ellen-and-on.mp3" }
)
