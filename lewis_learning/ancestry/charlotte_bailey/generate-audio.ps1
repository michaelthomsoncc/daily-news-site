# Generate ancestry walk MP3s via xAI TTS API
...
$files = @(
    @{ src = "1-charlottes-earsdon.txt"; out = "01-charlottes-earsdon.mp3" }
    @{ src = "2-north-east-scottish.txt"; out = "02-north-east-scottish.mp3" }
    @{ src = "3-from-church-to-you.txt"; out = "03-from-church-to-you.mp3" }
)
