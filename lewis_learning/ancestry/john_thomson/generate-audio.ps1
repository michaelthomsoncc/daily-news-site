# Generate John Thomson ancestry MP3s via xAI TTS API
...
$files = @(
    @{ src = "1.txt"; out = "01-steppe-to-carrick.mp3" }
    @{ src = "2.txt"; out = "02-faughart-to-eskdale.mp3" }
    @{ src = "3.txt"; out = "03-reivers-and-wharton.mp3" }
    @{ src = "4.txt"; out = "04-penicuik-to-sunderland.mp3" }
)
